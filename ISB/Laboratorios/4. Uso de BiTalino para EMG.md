...
Preparacion:
La preparacion del usurio es fundamental para la correcta adquisición de la data, el usuario no debe contener objetos que puedan interferir con la señal como los aretes, collares y relojes. La piel debe estar limpia sin cremas ni lociones, el posicionamiento  del usuario a la hora de la toma de la data dede ser sentado o echado. El entorno debe ser optimo y sin objetos alrededor que puedan alterar la adquisicion de la señal.
